...
function Home() {
  ...
  return (
 <section className="flex flex-col items-center text-white text-base sm:text-lg md:text-xl  px-4 sm:px-6 lg:px-8 mt-8 sm:mt-12 lg:mt-24 max-w-7xl mx-auto font-poppins">
