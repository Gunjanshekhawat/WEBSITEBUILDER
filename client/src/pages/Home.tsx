...
function Home() {
  ...
  return (
 <section className="flex flex-col items-center text-white text-sm pb-12 sm:pb-16 lg:pb-20 px-4 sm:px-6 lg:px-10 mt-8 sm:mt-12 lg:mt-24 max-w-7xl mx-auto font-poppins">
