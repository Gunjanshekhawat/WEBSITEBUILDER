...
function Home() {
  ...
  return (
 <section className="flex flex-col items-center text-white text-sm  px-4 sm:px-8 lg:px-8 mt-16 sm:mt-20 lg:mt-22 max-w-7xl mx-auto font-poppins">
         

        <h1 className="text-center text-4xl sm:text-6xl md:text-5xl lg:text-6xl leading-tight md:leading-[70px] mt-4 sm:mt-8 font-semibold max-w-3xl mx-auto">
